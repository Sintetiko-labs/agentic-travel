// Command virgin is an unofficial, agent-friendly CLI for Virgin Hotels.
package main
...
func usage() {
	fmt.Fprintf(os.Stderr, `virgin — unofficial CLI for Virgin Hotels
