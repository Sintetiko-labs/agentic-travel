// Command bless is an unofficial, agent-friendly CLI for BLESS Collection.
package main
...
func usage() {
	fmt.Fprintf(os.Stderr, `bless — unofficial CLI for BLESS Collection
