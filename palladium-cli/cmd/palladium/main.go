// Command palladium is an unofficial, agent-friendly CLI for Palladium.
package main
...
func usage() {
	fmt.Fprintf(os.Stderr, `palladium — unofficial CLI for Palladium
