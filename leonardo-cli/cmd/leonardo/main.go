// Command leonardo is an unofficial, agent-friendly CLI for Leonardo Hotels.
package main
...
func usage() {
	fmt.Fprintf(os.Stderr, `leonardo — unofficial CLI for Leonardo Hotels
