// Command garden is an unofficial, agent-friendly CLI for Garden Hotels.
package main
...
func usage() {
	fmt.Fprintf(os.Stderr, `garden — unofficial CLI for Garden Hotels
