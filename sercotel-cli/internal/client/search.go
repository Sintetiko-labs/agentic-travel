...
const hotelsListingPath = "/es/hoteles-y-destinos"
...
func (c *Client) Search(query string, page, pageSize int) (*HotelSearchResult, error) {
	...
	rows := parse.HotelsFromSercotelRSC(html, c.BaseURL)
	...
	return ldToResult(filtered, query, page, pageSize, brandOrDefault(c.Brand, "Sercotel"), c.BaseURL, "rsc-json"), nil
}
