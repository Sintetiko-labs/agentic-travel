// Command iberostar is an unofficial, agent-friendly CLI for Iberostar.
package main
...
func usage() {
	fmt.Fprintf(os.Stderr, `iberostar — unofficial CLI for Iberostar
